# ------------------------------------------------------------------------------ #
# Code for Nonparametric: Literature Search and Data Extraction for TOS 2018
...
date_attah
# ------------------------------------------------------------------------------ #
meta_orel <- entrez_search(db = "pmc", 
                           term = "10.1515/raon-2017-0060[doi]")
summs_orel <- entrez_summary(db = "pmc", id = meta_orel$ids)
date_orel <- extract_from_esummary(summs_orel, "pubdate")
date_orel
# ------------------------------------------------------------------------------ #
...
date_quesada
# ------------------------------------------------------------------------------ #
meta_raaijmakers <- entrez_search(db = "pmc", 
                                  term = "10.1371/journal.pone.0173349[doi]")
summs_raaijmakers <- entrez_summary(db = "pmc", id = meta_raaijmakers$ids)
date_raaijmakers <- extract_from_esummary(summs_raaijmakers, "pubdate")
date_raaijmakers
# ------------------------------------------------------------------------------ #
...
date_stefan
# ------------------------------------------------------------------------------ #
meta_vandenbossche <- entrez_search(db = "pmc", 
                                    term = "10.1128/AEM.02766-16[doi]")
summs_vandenbossche <- entrez_summary(db = "pmc", id = meta_vandenbossche$ids)
date_vandenbossche <- extract_from_esummary(summs_vandenbossche, "pubdate")
date_vandenbossche
# ------------------------------------------------------------------------------ #
...
date_pischke
# ------------------------------------------------------------------------------ #
meta_swanton <- entrez_search(db = "pmc", 
                              term = "10.1002/osp4.90[doi]")
summs_swanton <- entrez_summary(db = "pmc", id = meta_swanton$ids)
date_swanton <- extract_from_esummary(summs_swanton, "pubdate")
date_swanton
# ------------------------------------------------------------------------------ #
...
date_julian
# ------------------------------------------------------------------------------ #
meta_prazlenkova <- entrez_search(db = "pmc", 
                                  term = "10.1371/journal.pone.0183449[doi]")
summs_prazlenkova <- entrez_summary(db = "pmc", id = meta_prazlenkova$ids)
date_prazlenkova <- extract_from_esummary(summs_prazlenkova, "pubdate")
date_prazlenkova
# ------------------------------------------------------------------------------ #
...
citation_attah 
citation_orel <- cr_citation_count(doi = "10.1515/raon-2017-0060")
citation_orel 
citation_quesada <- cr_citation_count(doi = "10.1371/journal.pone.0175462")
citation_quesada
citation_raaijmakers <- cr_citation_count(doi = "10.1371/journal.pone.0173349")
citation_raaijmakers
...
citation_stefan
citation_vandenbossche <- cr_citation_count(doi = "10.1128/AEM.02766-16")
citation_vandenbossche
...
citation_pischke
citation_swanton <- cr_citation_count(doi = "10.1002/osp4.90")
citation_swanton
citation_julian <- cr_citation_count(doi = "10.14740/jocmr3142w")
citation_julian
citation_prazlenkova <- cr_citation_count(doi = "10.1371/journal.pone.0183449")
citation_prazlenkova
...
alt_orel <- altmetrics(doi = "10.1515/raon-2017-0060") # no metrics found 
alt_raaijmakers <- altmetrics(doi = "10.1371/journal.pone.0173349") # no metrics found 
...
alt_pedersen <- altmetrics(doi = "10.1371/journal.pone.0186384") # no metrics found 
alt_pischke <- altmetrics(doi = "10.4254/wjh.v9.i8.427") # no metrics found 
alt_swanton <- altmetrics(doi = "10.1002/osp4.90") # no metrics found 
...
alt_vandenbossche <- altmetrics(doi = "10.1128/AEM.02766-16")
...
alt_prazlenkova <- altmetrics(doi = "10.1371/journal.pone.0183449")
alt_paalvast <- altmetrics(doi = "10.14814/phy2.13376")

# Extract from many DOIs
library("magrittr")
library("purrr")
