...
# ------------------------------------------------------------------------------ #
# Define search query and create object for search string 
# ------------------------------------------------------------------------------ #
...
# Ran for manuscript on December 9, 2020 
citation_golshan <- cr_citation_count(doi = "10.22038/AJP.2016.7844")
citation_golshan
# Golshan returned NA, so citation count 20 was obtained from Google Scholar
...
# Citation counts updated manually in 
# manuscript_materials_2020_data_review_citations.xlsx
